  ...
  return (
    <div className="grid gap-4 py-4">
      <div className="grid gap-2">
        ...
        <Input
          id="image-url"
          placeholder="cth. https://source.unsplash.com/random"
      ...
      <div className="grid gap-2">
        <Label htmlFor="alt-text">Kata Alternatif</Label>
        <Input
          id="alt-text"
          placeholder="cth. Gambar random dari unsplash"
...
export function InsertImageUploadedDialogBody({
  ...
  return (
    <div className="grid gap-4 py-4">
      ...
      <div className="grid gap-2">
        <Label htmlFor="alt-text">Alternative Teks</Label>
        <Input
          id="alt-text"
          placeholder="cth. Tugas matematika"
          onChange={(e) => setAltText(e.target.value)}
          value={altText}
          data-test-id="image-modal-alt-text-input"
        />
